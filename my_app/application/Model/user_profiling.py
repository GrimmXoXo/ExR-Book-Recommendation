...
class UserProfiling:
    ...
    def get_reviewer_profile(self):
        # import sqlite3
        # import ast
        # connection=sqlite3.connect('path-to-book-reviews.db')
    ...
    @staticmethod
    def load_profiles():
        profiles = UserProfiling.load_pickle('application/Model/profiles.pkl')
        return profiles['user_profiles'], profiles['item_profiles_filtered']

    @staticmethod
    def recommend_books( user_id=None, book_id=None, top_n=10):
        user_profiles, item_profiles = UserProfiling.load_profiles()
